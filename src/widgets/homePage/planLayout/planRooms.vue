<template>
  <div class="planRooms w-full pt-7.5">
    ...
    <div class="planRooms__btns flex items-center gap-x-7.5 mt-7.5">
      ...
      <MyButton :theme="'green'"> Загрузить 3D-планировки </MyButton>
      <Button
        type="button"
        @click="toggle"
        aria-haspopup="true"
...
const menuActionsItems = ref([
  ...
  },
  {
    ...
    command: () => {
      console.log("Отключить отображение сторон света");
    },
  },
  {
    ...
    style: "!text-red",
    command: () => {
      console.log("Удалить планировки");
    },
  },
]);
